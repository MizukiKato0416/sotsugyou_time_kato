...
// マクロ定義
//=============================================================================
#define CREDIT_PICTURE_FRAME_SIZE		(1.75f)		//フレームのサイズ
