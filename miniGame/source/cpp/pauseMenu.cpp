...
HRESULT CPauseMenu::Init(void) {
	...
	//選択肢UIの詳細設定
	SetSelectUI(0, SELECT_TITLE_POS, SELECT_UI_WIDTH, SELECT_UI_HEIGHT, CTexture::TEXTURE_TYPE::PAUSE_TITLE);
	SetSelectUI(1, SELECT_RESTATE_POS, SELECT_UI_WIDTH, SELECT_UI_HEIGHT, CTexture::TEXTURE_TYPE::PAUSE_RESTATE);
	SetSelectUI(2, SELECT_CONTINUE_POS, SELECT_UI_WIDTH, SELECT_UI_HEIGHT, CTexture::TEXTURE_TYPE::PAUSE_CONTINUE);
	//選択肢アイコンの生成
